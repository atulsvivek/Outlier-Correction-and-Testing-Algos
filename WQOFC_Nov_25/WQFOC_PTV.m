function [U_Corrected,V_Corrected,U_Residual,V_Residual,Eval]= WQFOC_PTV(U_Errored,V_Errored,X,Y)
...
% To Remove Errorneous vectors by comparison with the curve fitted basis
% field
[U_Corrected,V_Corrected,Eval]  = FinalCorrector_PTV(U_Errored(:),V_Errored(:),U_Corrected,V_Corrected,X_Block,Y_Block,Ipos,NeighborIndex,GridSize);
